...
RESCOMP = windres
DEFINES += -D_CRT_SECURE_NO_WARNINGS -D_GLFW_X11
INCLUDES += -I../vendor/glfw/include -I../vendor/glfw/src
FORCE_INCLUDE +=
...
$(OBJDIR)/posix_module.o: ../vendor/glfw/src/posix_module.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/posix_poll.o: ../vendor/glfw/src/posix_poll.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
